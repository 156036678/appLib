...
package com.xiay.applib.view.tab;
 ...
 *
 */
public abstract class BaseGradientTabStrip extends View {
    ...
    public BaseGradientTabStrip(Context context) {
        super(context);
        initView();
    }

    public BaseGradientTabStrip(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    @TargetApi(11)
    public BaseGradientTabStrip(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    @TargetApi(21)
    public BaseGradientTabStrip(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
