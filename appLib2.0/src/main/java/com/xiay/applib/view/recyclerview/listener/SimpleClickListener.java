...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    protected RecyclerBaseAdapter baseQuickAdapter;
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        if (recyclerView == null) {
            ...
            this.baseQuickAdapter = (RecyclerBaseAdapter) recyclerView.getAdapter();
        ...
        if (!mGestureDetector.onTouchEvent(e) && e.getActionMasked() == MotionEvent.ACTION_UP && mIsShowPress) {
            if (mPressedView!=null){
                RecyclerViewHolder vh = (RecyclerViewHolder) recyclerView.getChildViewHolder(mPressedView);
...
//                mPressedView.setPressed(true);
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            if (mIsPrepressed && mPressedView != null) {
                ...
                RecyclerViewHolder vh = (RecyclerViewHolder) recyclerView.getChildViewHolder(pressedView);
     ...
     */
    public abstract void onItemClick(RecyclerBaseAdapter adapter, View view, int position);
     ...
     */
    public abstract void onItemLongClick(RecyclerBaseAdapter adapter, View view, int position);

    public abstract void onItemChildClick(RecyclerBaseAdapter adapter, View view, int position);

    public abstract void onItemChildLongClick(RecyclerBaseAdapter adapter, View view, int position);
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        ...
        if (baseQuickAdapter==null){
            if (recyclerView!=null){
                baseQuickAdapter= (RecyclerBaseAdapter) recyclerView.getAdapter();
            }else {
                return false;
            }
        }
