package com.xiay.applib.view.recyclerview.loadmore;
...
public abstract class LoadMoreView {
    ...
    private void visibleLoading(RecyclerViewHolder holder, boolean visible) {
        holder.setVisible(getLoadingViewId(), visible);
    }

    private void visibleLoadFail(RecyclerViewHolder holder, boolean visible) {
        holder.setVisible(getLoadFailViewId(), visible);
    }

    private void visibleLoadEnd(RecyclerViewHolder holder, boolean visible) {
     ...
     * @deprecated Use {@link RecyclerBaseAdapter#loadMoreEnd(boolean)} instead.
     */
    @Deprecated
