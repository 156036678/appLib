...
import com.xiay.applib.view.recyclerview.animation.AlphaInAnimation;
import com.xiay.applib.view.recyclerview.animation.BaseAnimation;
import com.xiay.applib.view.recyclerview.animation.ScaleInAnimation;
import com.xiay.applib.view.recyclerview.animation.SlideInBottomAnimation;
import com.xiay.applib.view.recyclerview.animation.SlideInLeftAnimation;
import com.xiay.applib.view.recyclerview.animation.SlideInRightAnimation;
import com.xiay.applib.view.recyclerview.entity.IExpandable;
import com.xiay.applib.view.recyclerview.loadmore.LoadMoreView;
import com.xiay.applib.view.recyclerview.loadmore.SimpleLoadMoreView;
...
public abstract class RecyclerBaseAdapter<ADT> extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    private RecyclerViewHolder getLoadingView(ViewGroup parent) {
        View view = getItemView(mLoadMoreView.getLayoutId(), parent);
        RecyclerViewHolder holder = createRecyclerViewHolder(view);
     ...
     */
    @Override
    public void onBindViewHolder(RecyclerViewHolder holder, int positions) {
    ...
    protected RecyclerViewHolder onCreateDefViewHolder(ViewGroup parent, int viewType) {
        return createRecyclerViewHolder(parent, mLayoutResId);
    }

    protected RecyclerViewHolder createRecyclerViewHolder(ViewGroup parent, int layoutResId) {
        return createRecyclerViewHolder(getItemView(layoutResId, parent));
    }

    /**
     * if you want to use subclass of RecyclerViewHolder in the adapter,
    ...
    /**
     * When the current adapter is empty, the RecyclerBaseAdapter can display a special view
