...
import com.xiay.applib.view.recyclerview.listener.OnItemDragListener;
import com.xiay.applib.view.recyclerview.listener.OnItemSwipeListener;

import java.util.Collections;
import java.util.List;


public abstract class RecyclerItemDraggableAdapter<T> extends RecyclerBaseAdapter<T> {
    ...
    public RecyclerItemDraggableAdapter(List<T> data) {
        super(data);
    }

    public RecyclerItemDraggableAdapter(int layoutResId, List<T> data) {
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int positions) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != LOADING_VIEW && viewType != HEADER_VIEW
            ...
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                ...
                if (toggleView != null) {
                    toggleView.setTag(R.id.RecyclerBaseAdapter_viewholder_support, holder);
                    if (mDragOnLongPress) {
                ...
                holder.itemView.setTag(R.id.RecyclerBaseAdapter_viewholder_support, holder);
            ...
            mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mItemTouchHelper != null && itemDragEnabled) {
                        mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(R.id.RecyclerBaseAdapter_viewholder_support));
                    }
                    return true;
                }
            };
     ...
     * You should attach {@link ItemTouchHelper} which construct  to the Recycler when you enable this.
     */
