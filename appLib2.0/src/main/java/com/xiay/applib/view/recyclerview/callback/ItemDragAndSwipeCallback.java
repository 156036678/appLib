package com.xiay.applib.view.recyclerview.callback;
...
import com.xiay.applib.view.recyclerview.RecyclerItemDraggableAdapter;
...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
    ...
    RecyclerItemDraggableAdapter mAdapter;
    ...
    public ItemDragAndSwipeCallback(RecyclerItemDraggableAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState == ItemTouchHelper.ACTION_STATE_DRAG
            ...
            viewHolder.itemView.setTag(R.id.RecyclerBaseAdapter_dragging_support, true);
        } else if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE
                && !isViewCreateByAdapter(viewHolder)) {
            mAdapter.onItemSwipeStart(viewHolder);
            viewHolder.itemView.setTag(R.id.RecyclerBaseAdapter_swiping_support, true);
        }
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getTag(R.id.RecyclerBaseAdapter_dragging_support) != null
                && (Boolean)viewHolder.itemView.getTag(R.id.RecyclerBaseAdapter_dragging_support)) {
            mAdapter.onItemDragEnd(viewHolder);
            viewHolder.itemView.setTag(R.id.RecyclerBaseAdapter_dragging_support, false);
        }
        if (viewHolder.itemView.getTag(R.id.RecyclerBaseAdapter_swiping_support) != null
                && (Boolean)viewHolder.itemView.getTag(R.id.RecyclerBaseAdapter_swiping_support)) {
            mAdapter.onItemSwipeClear(viewHolder);
            viewHolder.itemView.setTag(R.id.RecyclerBaseAdapter_swiping_support, false);
        }
    }
