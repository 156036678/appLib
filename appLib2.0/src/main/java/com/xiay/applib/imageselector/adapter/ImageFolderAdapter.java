...
public class ImageFolderAdapter extends RecyclerView.Adapter<ImageFolderAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.image_selector_item_folder,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        Glide.with(context)
                ...
                .placeholder(R.mipmap.image_selector_placeholder)
                .error(R.mipmap.image_selector_placeholder)
                .centerCrop()
