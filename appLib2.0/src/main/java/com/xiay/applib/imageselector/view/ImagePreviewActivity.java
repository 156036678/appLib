...
public class ImagePreviewActivity extends AppCompatActivity {
    ...
    public static void startPreview(Activity context,int requestCode, List<LocalMedia> images, List<LocalMedia> selectImages, int maxSelectNum, int position){
        Intent intent = getIntent(context, (ArrayList) images, (ArrayList) selectImages, maxSelectNum, position);
    ...
    private static Intent getIntent(Activity context, ArrayList images, ArrayList selectImages, int maxSelectNum, int position) {
