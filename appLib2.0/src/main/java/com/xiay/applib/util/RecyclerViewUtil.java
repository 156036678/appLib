...
public class RecyclerViewUtil<ADT> {
    int currentPage;
    ...
    public RecyclerViewUtil( Activity activity,RecyclerView rv_list,RecyclerBaseAdapter adapter,SwipeRefreshLayout swipeRefreshLayout,int perPageSize,String emptyMessage) {
    ...
    public RecyclerViewUtil( Activity activity,RecyclerView rv_list,RecyclerBaseAdapter adapter,SwipeRefreshLayout swipeRefreshLayout,int currentPage,int perPageSize) {
        this(activity,rv_list,adapter,swipeRefreshLayout,perPageSize,null);
    }
    public RecyclerViewUtil( Activity activity,RecyclerView rv_list,RecyclerBaseAdapter adapter,SwipeRefreshLayout swipeRefreshLayout,int currentPage) {
