...
package com.xiay.applib.util.autolayout.utils;
...
import cn.xiay.util.autolayout.AutoLayoutInfo;
import cn.xiay.util.autolayout.attr.DrawablePaddingAttr;
import cn.xiay.util.autolayout.attr.HeightAttr;
import cn.xiay.util.autolayout.attr.MarginAttr;
import cn.xiay.util.autolayout.attr.MarginBottomAttr;
import cn.xiay.util.autolayout.attr.MarginLeftAttr;
import cn.xiay.util.autolayout.attr.MarginRightAttr;
import cn.xiay.util.autolayout.attr.MarginTopAttr;
import cn.xiay.util.autolayout.attr.MaxHeightAttr;
import cn.xiay.util.autolayout.attr.MaxWidthAttr;
import cn.xiay.util.autolayout.attr.MinHeightAttr;
import cn.xiay.util.autolayout.attr.MinWidthAttr;
import cn.xiay.util.autolayout.attr.PaddingAttr;
import cn.xiay.util.autolayout.attr.PaddingBottomAttr;
import cn.xiay.util.autolayout.attr.PaddingLeftAttr;
import cn.xiay.util.autolayout.attr.PaddingRightAttr;
import cn.xiay.util.autolayout.attr.PaddingTopAttr;
import cn.xiay.util.autolayout.attr.TextSizeAttr;
import cn.xiay.util.autolayout.attr.WidthAttr;
import cn.xiay.util.autolayout.config.AutoLayoutConifg;
import cn.xiay.util.autolayout.utils.DimenUtils;
